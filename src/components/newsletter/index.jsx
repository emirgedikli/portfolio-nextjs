...
let styles = {
  ...
  inputEmail:
    "block w-full px-4 py-2 text-white border rounded-md dark:bg-gray-800 dark:border-gray-700 focus:border-blue-700 focus:ring-blue-700 dark:focus:border-blue-800 focus:outline-none focus:ring focus:ring-opacity-40",
  div2divB: "w-full mt-4",
  message: "block mb-2 text-sm font-medium text-white",
  divBtextarea:
    "block w-full h-40 px-4 py-2 text-white border rounded-md dark:bg-gray-800 dark:border-gray-700 focus:border-blue-700 dark:focus:border-blue-800 focus:outline-none focus:ring focus:ring-blue-800 focus:ring-opacity-40",
