...
let styles = {
  ...
  CSdivHtml1: "bg-[#374151] rounded-full my-10 p-10 w-48 h-48",
  CSdivCss: "carousel-item relative float-left w-full",
  CSdivCss1: "bg-[#374151] rounded-full my-10 p-10 w-48 h-48",
  CSdivJavascript: "carousel-item relative float-left w-full",
  CSdivJavascript1: "bg-[#374151] rounded-full my-10 p-10 w-48 h-48",
  CSdivWebpack: "carousel-item relative float-left w-full",
  CSdivWebpack1: "bg-[#374151] rounded-full my-10 pt-10 w-48 h-48",
  CSdivBootstrap: "carousel-item relative float-left w-full",
  CSdivBootstrap1: "bg-[#374151] rounded-full my-10 pt-6 w-48 h-48",
  CSdivTailwind: "carousel-item relative float-left w-full",
  CSdivTailwind1: "bg-[#374151] rounded-full my-10 pt-8 w-48 h-48",
  CSdivWordpress: "carousel-item relative float-left w-full",
  CSdivWordpress1: "bg-[#374151] rounded-full my-10 pt-10 w-48 h-48",
  CSdivReactjs: "carousel-item relative float-left w-full",
  CSdivReactjs1: "bg-[#374151] rounded-full my-10 p-10 w-48 h-48",
  CSdivNextjs: "carousel-item relative float-left w-full",
  CSdivNextjs1: "bg-[#374151] rounded-full my-10 pt-10 w-48 h-48",
  CSdivPhp: "carousel-item relative float-left w-full",
  CSdivPhp1: "bg-[#374151] rounded-full my-10 pt-14 w-48 h-48",
  CSdivSql: "carousel-item relative float-left w-full",
  CSdivSql1: "bg-[#374151] rounded-full my-10 pt-14 w-48 h-48",
  CSdivNodejs: "carousel-item relative float-left w-full",
  CSdivNodejs1: "bg-[#374151] rounded-full my-10 pt-12 w-48 h-48",
  CSdivNpm: "carousel-item relative float-left w-full",
  CSdivNpm1: "bg-[#374151] rounded-full my-10 pt-8 w-48 h-48",
  CSdivGit: "carousel-item relative float-left w-full",
  CSdivGit1: "bg-[#374151] rounded-full my-10 p-10 w-48 h-48",
  CSImage: "flex justify-center pb-4",
...
let Carousel = () => {
  return (
    ...
    <div className={styles.CSdiv}>
      {/* CS div Carousel*/}
      <div
        className={styles.CSdivCarousel}
        ...
        <div className={styles.CSdivCarousel1}>
          ...
          <div className={styles.CSdivHtml}>
            ...
            <div className={styles.CSdivHtml1}>
              ...
              <div className={styles.CSImage}>
                <Image src={Html} alt="Html" height={70} width={90} />
              </div>
              {/* CS div Html 3 */}
              <div>
          ...
          <div className={styles.CSdivCss}>
            ...
            <div className={styles.CSdivCss1}>
              {/* CS div Css 2 */}
              <div className={styles.CSImage}>
                <Image src={Css} alt="Css" height={70} width={70} />
              </div>
              {/* CS div Css 3 */}
              <div>
          ...
          <div className={styles.CSdivWebpack}>
            ...
            <div className={styles.CSdivWebpack1}>
              {/* CS div Webpack 2 */}
              <div className={styles.CSImage}>
                <Image src={Webpack} alt="Webpack" height={80} width={80} />
              </div>
              {/* CS div Webpack 3 */}
              <div>
          ...
          <div className={styles.CSdivBootstrap}>
            ...
            <div className={styles.CSdivBootstrap1}>
              {/* CS div Bootstrap 2 */}
              <div className={styles.CSImage}>
                <Image src={Bootstrap} alt="Bootstrap" height={90} width={120} />
              </div>
              {/* CS div Bootstrap 3 */}
              <div>
          ...
          <div className={styles.CSdivTailwind}>
            ...
            <div className={styles.CSdivTailwind1}>
              {/* CS div Tailwind 2 */}
              <div className={styles.CSImage}>
                <Image src={Tailwind} alt="Tailwind" height={80} width={80} />
              </div>
              {/* CS div Tailwind 3 */}
              <div>
          ...
          <div className={styles.CSdivWordpress}>
            ...
            <div className={styles.CSdivWordpress1}>
              {/* CS div Wordpress 2 */}
              <div className={styles.CSImage}>
                <Image src={Wordpress} alt="Wordpress" height={80} width={80} />
              </div>
              {/* CS div Wordpress 3 */}
              <div>
          ...
          <div className={styles.CSdivReactjs}>
            ...
            <div className={styles.CSdivReactjs1}>
              {/* CS div Reactjs 2 */}
              <div className={styles.CSImage}>
                <Image src={Reactjs} alt="Reactjs" height={80} width={90} />
              </div>
              {/* CS div Reactjs 3 */}
              <div>
          ...
          <div className={styles.CSdivNextjs}>
            ...
            <div className={styles.CSdivNextjs1}>
              {/* CS div Nextjs 2 */}
              <div className={styles.CSImage}>
                <Image src={Nextjs} alt="Nextjs" height={80} width={100} />
              </div>
              {/* CS div Nextjs 3 */}
              <div>
          ...
          <div className={styles.CSdivPhp}>
            ...
            <div className={styles.CSdivPhp1}>
              {/* CS div Php 2 */}
              <div className={styles.CSImage}>
                <Image src={Php} alt="Php" height={50} width={90} />
              </div>
              {/* CS div Php 3 */}
              <div>
          ...
          <div className={styles.CSdivSql}>
            ...
            <div className={styles.CSdivSql1}>
              {/* CS div Sql 2 */}
              <div className={styles.CSImage}>
                <Image src={Sql} alt="Sql" height={50} width={90} />
              </div>
              {/* CS div Sql 3 */}
              <div>
          ...
          <div className={styles.CSdivNodejs}>
            ...
            <div className={styles.CSdivNodejs1}>
              {/* CS div Nodejs 2 */}
              <div className={styles.CSImage}>
                <Image src={Nodejs} alt="Nodejs" height={60} width={90} />
              </div>
              {/* CS div Nodejs 3 */}
              <div>
          ...
          <div className={styles.CSdivNpm}>
            ...
            <div className={styles.CSdivNpm1}>
              {/* CS div Npm 2 */}
              <div className={styles.CSImage}>
                <Image src={Npm} alt="Npm" height={90} width={100} />
              </div>
              {/* CS div Npm 3 */}
              <div>
          ...
          <div className={styles.CSdivGit}>
            ...
            <div className={styles.CSdivGit1}>
              {/* CS div Git 2 */}
              <div className={styles.CSImage}>
                <Image src={Git} alt="Git" height={80} width={80} />
              </div>
              {/* CS div Git 3 */}
              <div>
